...
const QString BITCOIN_IPC_PREFIX("triplechain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click triplechain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start triplechain: click-to-pay handler");
    else
...
{
    // clicking on triplechain: URLs creates FileOpen events on the Mac:
