#############################################################################
# Makefile for building: triplechain
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 8? 28 09:30:42 2017
# Project:  triplechain.pro
# Template: app
# Command: c:/Qt/4.8.6/bin/qmake.exe -o Makefile triplechain.pro
#############################################################################
...
Makefile: triplechain.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -o Makefile triplechain.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/triplechain20170820/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/triplechain20170820/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/triplechain20170820/src/leveldb/libleveldb.a: FORCE
	cd C:/triplechain20170820/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -O2" libleveldb.a libmemenv.a && ranlib C:/triplechain20170820/src/leveldb/libleveldb.a && ranlib C:/triplechain20170820/src/leveldb/libmemenv.a
